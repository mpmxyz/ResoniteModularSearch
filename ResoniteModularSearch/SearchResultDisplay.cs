...
#pragma warning restore CS8601 // Possible null reference assignment.
    ...
    public SearchResultDisplay(Slot hierarchyContentRoot, Slot componentContentRoot, SyncRef<IWorldElement> selectionRef) {
    ...
    public static SearchResultDisplay Create(Slot slot, UIBuilder builder) {
        ...
        var hiearchyContent = builder.VerticalLayout().Slot;
        builder.NestOut();
        ...
        SearchResultDisplay display = new(hiearchyContent, componentContent, selectionRef);
        return display;
    }
